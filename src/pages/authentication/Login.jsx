...
export default function Login() {
  ...
  const { response, isUserExist, loading, forgotPass } = useSelector(
  ...
  const clickLogin = (e) => {
    if (
      ...
      dispatch(checkUserExist(loginUsernameFormik.values.username));
                        ...
                        <div class="otp-titleMain formText text-center">
                          ...
                          <div class="otp-send-to">
                            <p>
                              ...
                              <label for="">
                                {" "}
                                &nbsp; +91 {loginUsernameFormik.values.username}
                              </label>
                            </p>
                          </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                  <div class="otp-btnCol btnTopSpace">
                                    <button
                                      ...
                                      onClick={()=>{!loading && dispatch(loginWithOtp({
                                        userName: loginUsernameFormik.values.username,
                                        password: loginPasswordFormik.values.password,
                                        ip,
                                        otp,
